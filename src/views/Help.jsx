  ...
  return (
    <main style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto" }}>
      ...
      <section style={{ marginTop: "1.5rem" }}>
        <h2>⚙️ Funcionamiento general del clon</h2>
        <p>
          Esta aplicación simula un funcionamiento simple y básico de WhatsApp Web.
          Permite iniciar sesión, acceder a una sala de chat y mantener el estado
          del usuario activo gracias a <strong>localStorage</strong>.
      ...
      <section style={{ marginTop: "1.5rem" }}>
        ...
        <ul>
          ...
          <li>Incluir soporte de temas (claro/oscuro) en la configuración.</li>
